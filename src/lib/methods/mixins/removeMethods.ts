...
export function removeMethods<T extends Constructor>(base: T): Constructor & T {
  return class extends base {
    ...
    //     console.log(`Billboard ${billboardId} removed.`);
    //     await client.query('COMMIT');
    //   } catch (error: any) {
    //     await client.query('ROLLBACK');
    //     console.error(`Error remove billboard: ${billboardId}`, error.message);
    //   } finally {
    //     client.release();
    //   }
    // }
    ...
    //   } catch (error: any) {
    //     await client.query('ROLLBACK');
    //     console.error(`Error remove category: ${categoryId}`, error.message);
    //   } finally {
    //     client.release();
    //   }
    // }
